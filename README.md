...
- Structured logic for dynamic Terraform generation, syntax highlighting, and exportable ZIP structures.
...
- Connected logistics fulfillment with **Shiprocket APIs** for automated tracking.
- Secured backend with Row Level Security (RLS) policies on **Supabase PostgreSQL**.
...
- Automated API communication with the LinkedIn OAuth platform for instant publication.
- Set up immediate subscriber notification updates over email.
...
- Configured **AWS SES** integration for automated, structured email alerts to team administrators.
...
- Implemented light/dark modes aligned with elegant typographic choices.
- **Tech Stack:** React, Vite, Tailwind CSS, Framer Motion, React Helmet, JSON-LD Schema
...
<p align="center">
  <a href="https://www.credly.com/badges/9dba3dd3-ed09-4af6-98a5-15ddfaca774d/public" target="_blank">
    <img src="https://images.credly.com/images/0e284c3f-5164-4b21-8660-0d84737941bc/linkedin_thumb_image.png" width="210" height="110" alt="AWS Certified Solutions Architect" />
  </a>&nbsp;&nbsp;&nbsp;&nbsp;
...
- ☁️ Advanced AWS Architecture & Cloud Security
- 🐳 Kubernetes orchestration & DevOps CI/CD pipeline optimization
